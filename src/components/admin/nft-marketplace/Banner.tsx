    ...
    >
      <div className="w-full">
        ...
        <div className="mt-[36px] flex items-center justify-between gap-4 sm:justify-start 2xl:gap-10">
          <button className="text-black linear rounded-xl bg-surface px-4 py-2 text-center text-base font-medium transition duration-200 hover:!bg-surface/80 active:!bg-surface/70">
            Discover now
          </button>
